# -*- coding: utf-8 -*-
"""2026 单跑对比三种出口(同一 V3 信号集 550, 只统计 2026 入场):
  1) 三挡止盈 tp3=3.5%(pct 全平)
  2) 单档 tp1=1.5%/70%
  3) 三挡止盈 tp3=reverse_signal(反向信号全平剩余)
"""
...
T2025 = calendar.timegm((2025,1,1,0,0,0))
sel25=[t for t in sel if t[1] >= T2025*1000]
print("V3过滤后笔数:%d  其中2025入场:%d"%(len(sel), len(sel25)))
...
def report(name,er):
    ...
    print("\n== %s =="%name); metrics(y25,"2025")

# 1) 三挡止盈 tp3=3.5% (pct 全平)
report("① 三挡 tp3=3.5%(pct全平)",
