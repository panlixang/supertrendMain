"""BTC-USDT-SWAP 止盈止损档位寻优。

信号侧完全对齐线上：1h 周期、11×4.0、ER 0.1/0.12/0.12/0.3、打分制 50/50/55
动态阈值、A/B/C min_score=1、range 过滤器、10U×10x、max_loss 3%。
...
def main():
    ...
    out = {
        ...
        "filters": "线上 BTC：ER 0.1/0.12/0.12/0.3 + 打分制 50/50/55 动态 + A/B/C min_score=1 "
                   "+ range 过滤器(touches>=2) + 10U×10x 1h max_loss3%",
