"""ETH-USDT-SWAP 止盈止损档位寻优。

信号侧完全对齐线上：1h 周期、7×4.0、ER 0.12/0.12/0.3、打分制 35/35/30
动态阈值、A/B/C min_score=0、10U×10x、max_loss 3%。
...
def main():
    ...
    out = {
        ...
        "filters": "线上 ETH：ER 0.12 + 打分制 35/35/30 动态 + A/B/C min_score=0 + 10U×10x 1h max_loss3%",
