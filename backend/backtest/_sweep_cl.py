# -*- coding: utf-8 -*-
"""CL-USDT-SWAP (WTI 原油) 完整寻优：periods×multiplier、ER 档位、分数拦截、TP/SL 出场。
窗口：2026-03-04（上市）~ 2026-09-01，约半年。分阶段贪心。
信号侧对齐 BTC 线上：1h、11×4.0、ER 0.12/0.12/0.3、打分制 50/50/55 动态、min_score=1、
...
def main():
    ...
    # 基线：11×4.0 / er 0.12/0.12/0.3 / scoring 50/50/55 m1 / tp 0.5/1.5/3.0 sl3 ml3
    ...
    out = os.path.join(os.path.dirname(__file__), "_sweep_cl.json")
