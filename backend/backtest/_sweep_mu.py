# -*- coding: utf-8 -*-
"""MU-USDT-SWAP 参数寻优：periods×multiplier、ER 档位、分数拦截。
出场规则固定为线上 MU 增强档（tp1=1.5/30, tp2=2.5/40, tp3=4.0/100 reverse,
...
def main():
    ...
    # 基线：线上当前配置 22×3.0 / er 0.12/0.12/0.3 / scoring 45/45/35 m0
    base = one({"periods": 22, "multiplier": 3.0, "src": "hl2", "change_atr": True,
    ...
    periods = list(range(8, 26, 2))        # 8,10,...,24（含当前22）
    ...
    out = os.path.join(os.path.dirname(__file__), "_sweep_mu.json")
